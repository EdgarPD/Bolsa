...
public class VacanteDAO {
    ...
    */
    ...
    public void actualiza(Vacante p){
        Session session = sessionFactory.openSession();
        Transaction tx = null;
        try {
           tx = session.beginTransaction();
    ...
    public List<Vacante> vacantes() {
        ...
        try {
            ...
            String hql = "from Vacante";
            Query query = session.createQuery(hql);
            result = (List<Vacante>)query.list();
            tx.commit();
        }
        catch (Exception e) {
